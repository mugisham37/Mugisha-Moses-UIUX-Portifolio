    ...
    <section className="max-w-7xl mx-auto px-6 lg:px-8 py-20">
      <div className="text-center animate-on-scroll">
        <div className="bg-gradient-to-r from-accent-blue/20 to-accent-purple/20 rounded-xl2 p-12 glass-morphism">
          <h2 className="text-3xl font-bricolage font-semibold mb-4">Want to Work Together?</h2>
          <p className="text-lg text-neutral-400 mb-8 max-w-2xl mx-auto">
            Now that you know a bit more about me, I'd love to learn about your project and how I can help bring your
            vision to life.
          </p>
