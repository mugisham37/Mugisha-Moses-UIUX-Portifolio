...
export const metadata: Metadata = {
  title: "Terms of Service | Alex Morgan Portfolio",
  description: "Terms of service and legal information for Alex Morgan's design portfolio website.",
}
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 lg:px-8 py-24 md:py-32">
      ...
      <div className="prose prose-invert max-w-none">
        ...
        <p>
          These Terms of Service ("Terms") govern your use of the website located at alexmorgan.design ("Site") operated
          by Alex Morgan Design ("we", "us", or "our"). By accessing or using the Site, you agree to be bound by these
        ...
        <p>
          ...
          Alex Morgan Design and its licensors. The Site is protected by copyright, trademark, and other laws of both
          the United States and foreign countries. Our trademarks and trade dress may not be used in connection with any
          product or service without the prior written consent of Alex Morgan Design.
        </p>
        ...
        <p>
          Our Service may contain links to third-party web sites or services that are not owned or controlled by Alex
          Morgan Design. Alex Morgan Design has no control over, and assumes no responsibility for, the content, privacy
          policies, or practices of any third party web sites or services. You further acknowledge and agree that Alex
          Morgan Design shall not be responsible or liable, directly or indirectly, for any damage or loss caused or
        ...
        <ul className="list-disc pl-6 mt-4 space-y-2">
          <li>By email: legal@alexmorgan.design</li>
